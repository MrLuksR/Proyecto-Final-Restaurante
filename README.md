...
El objetivo es administrar los diferentes componentes del restaurante, como los productos, pedidos, clientes, mesas y personal, integrando una interfaz gráfica (UI) y una conexión a base de datos.
